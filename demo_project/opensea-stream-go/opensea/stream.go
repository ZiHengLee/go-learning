...
func (s StreamClient) on(eventType types.EventType, collectionSlug string, callback func(payload interface{})) func() {
	s.socket.Connect()
	...
	return func() {
		...
		leave.Receive("ok", func(response interface{}) {
...
func (s StreamClient) OnItemListed(collectionSlug string, Callback func(itemListedEvent interface{})) {
	s.on(types.ItemListed, collectionSlug, Callback)
}

func (s StreamClient) OnItemSold(collectionSlug string, Callback func(itemSoldEvent interface{})) {
	s.on(types.ItemSold, collectionSlug, Callback)
}
func (s StreamClient) OnItemTransferred(collectionSlug string, Callback func(itemTransferredEvent interface{})) {
	s.on(types.ItemTransferred, collectionSlug, Callback)
}
func (s StreamClient) OnItemCancelled(collectionSlug string, Callback func(itemCancelledEvent interface{})) {
	s.on(types.ItemCancelled, collectionSlug, Callback)
}
func (s StreamClient) OnItemReceivedBid(collectionSlug string, Callback func(itemReceivedBidEvent interface{})) {
	s.on(types.ItemReceivedBid, collectionSlug, Callback)
}
func (s StreamClient) OnItemReceivedOffer(collectionSlug string, Callback func(itemReceivedOfferEvent interface{})) {
	s.on(types.ItemReceivedOffer, collectionSlug, Callback)
}
func (s StreamClient) OnItemMetadataUpdated(collectionSlug string, Callback func(itemMetadataUpdatedEvent interface{})) {
